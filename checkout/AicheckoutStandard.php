...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_title" value="Standard Package">
    <input type="hidden" name="package_price" value="25000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>AI-Power Data Science And ML With Python – Standard Package</h3>
                <div class="price">25,000 PKR</div>
                <ul class="features-list">
                    <li>3–6 ML Models Full documentation + presentation slides</li>
                    <li>Data cleaning + data transformation</li>
                    <li>Feature engineering</li>
                    <li>Visualizations + EDA (Exploratory Data Analysis)</li>
                    <li>Model comparison & evaluation</li>
                    <li>Python scripts + Notebook + dashboards</li>
                </ul>
            </div>
