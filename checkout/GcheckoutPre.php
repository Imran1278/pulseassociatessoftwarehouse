...
<form action="../process_checkout.php" method="POST">
    <input type="hidden" name="service_title" value="Graphics Designing And Media Animation">
    <input type="hidden" name="package_title" value="Enterprise Package">
    <input type="hidden" name="package_price" value="30000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Graphics Designing And Media Animation – Premium Package</h3>
                <div class="price">30,000 PKR</div>
                <ul class="features-list">
                    <li>Full brand identity design</li>
                    <li>Brand guidelines book (PDF)</li>
                    <li>15–30 social media posts</li>
                    <li>Posters, brochures, product catalog</li>
