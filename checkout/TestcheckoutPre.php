...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_price" value="35,000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Software Testing & Quality Assurance – Enterprise Package</h3>
                <div class="price">35,000 PKR</div>
                <ul class="features-list">
                    <li>Manual + automation testing Dedicated QA resource for the duration of the project</li>
                    <li>Selenium / Cypress automation scripts</li>
                    <li>Full test plan, test strategy, test scenarios</li>
                    <li>Requirement analysis</li>
                    <li>Performance testing (JMeter)</li>
                    <li>API testing (Postman), CI/CD integration</li>
                    <li>Professional QA documentation, Security testing (basic)</li>
                </ul>
            </div>
