...
<form action="../process_checkout.php" method="POST">
    <input type="hidden" name="service_title" value="Mobile App Development">
    <input type="hidden" name="package_title" value="Enterprise Package">
    <input type="hidden" name="package_price" value="1 Lakh">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Mobile App Development – Premium Package</h3>
                <div class="price">1 Lakh PKR</div>
                <ul class="features-list">
                    <li>Android & iSO (Hybrid:Flutter / React Native)</li>
                    <li>12-30 Screens</li>
                    <li>Professional UI /UX</li>
                    <li>Complete Backend (Node.js, Laravel, Firebase)</li>
                    <li>Fully Functional Admin Panel</li>
                    <li>Payment Gateway, Live Tracking, Chat System, Advanced APi Integratione</li>
                </ul>
            </div>
