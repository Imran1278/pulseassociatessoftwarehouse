    ...
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Internet of Things (IoT) Solutions – Standard Package</h3>
                <div class="price">25,000 PKR</div>
                <ul class="features-list">
                    <li>Full IoT system (3–6 sensors) Professional documentation</li>
                    <li>Microcontroller (ESP32/NodeMCU/Raspberry Pi)</li>
                    <li>Cloud connectivity (Firebase, AWS IoT Core, Thingspeak)</li>
                    <li>Mobile app/dashboard</li>
                    <li>Automation</li>
                    <li>PCB diagram (basic)</li>
                </ul>
            </div>
