...
<form action="../process_checkout.php" method="POST">
    <input type="hidden" name="service_title" value="Internet of Things (IoT) Solutions">
    ...
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Internet of Things (IoT) Solutions – Enterprise Package</h3>
                <div class="price">50,000 PKR</div>
                <ul class="features-list">
                    <li>Large-scale IoT system</li>
                    <li>8–20 sensors</li>
                    <li>Custom PCB design</li>
                    <li>Complete cloud ecosystem</li>
                    <li>Mobile + Web + Admin Dashboard</li>
                    <li>Advanced data analytics (Python)</li>
                    <li>AI integration (predictive analytics)</li>
                    <li>Security protocols (MQTT with TLS)</li>
                    <li>Professional wiring + diagrams</li>
                </ul>
            </div>
