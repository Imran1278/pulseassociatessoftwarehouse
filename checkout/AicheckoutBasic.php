...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_price" value="8000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>AI-Power Data Science And ML With Python – Basic Package</h3>
                <div class="price">8,000 PKR</div>
                <ul class="features-list">
                    <li>Basic ML models (1–2)</li>
                    <li>Linear Regression</li>
                    <li>Logistic Regression</li>
                    <li>Small dataset (CSV/Excel)</li>
                    <li>Data cleaning</li>
                    <li>Visualizations (Matplotlib/Seaborn)</li>
                </ul>
            </div>
