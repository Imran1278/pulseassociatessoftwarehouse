...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_price" value="8,000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Internet of Things (IoT) Solutions – Basic Package</h3>
                <div class="price">8,000 PKR</div>
                <ul class="features-list">
                    <li>Simple IoT prototype 1–2 sensors only</li>
                    <li>Microcontroller setup (Arduino / ESP32)</li>
                    <li>Basic sensors (Temperature, Gas, Motion, etc.)</li>
                    <li>Data reading + serial monitoring</li>
                    <li>Simple mobile/web interface (basic)</li>
                    <li>Basic wiring diagram</li>
                </ul>
            </div>
