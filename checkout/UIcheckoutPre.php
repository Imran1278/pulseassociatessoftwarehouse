...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_price" value="45000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>UI / UX Designing And Developing – Premium Package</h3>
                <div class="price">45,000 PKR</div>
                <ul class="features-list">
                    <li>20-50 Screens (Full Application)</li>
                    <li>UI / UX For Both Mobile, Web Development</li>
