...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_price" value="10,000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Virtual Assistant Amazon – Basic Package</h3>
                <div class="price">10,000 PKR</div>
                <ul class="features-list">
                    <li>Product research (2–4 products)</li>
                    <li>Keyword research (basic)</li>
                    <li>Listing creation</li>
                    <li>Listing optimization (simple)</li>
                    <li>Search Term optimization</li>
                    <li>Competitor analysis</li>
                    <li>Basic PPC guidance (no campaign running)</li>
                </ul>
            </div>
