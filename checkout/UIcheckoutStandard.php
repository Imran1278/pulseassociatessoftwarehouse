...
<form action="../process_checkout.php" method="POST">
    <input type="hidden" name="service_title" value="UI / UX Designing And Developing">
    <input type="hidden" name="package_title" value="Standard Package">
    <input type="hidden" name="package_price" value="20000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>UI / UX Designing And Developing – Standard Package</h3>
                <div class="price">20,000 PKR</div>
                <ul class="features-list">
                    <li>6-15 Screens</li>
                    <li>Full App or Webiste UI / UX Design</li>
                    <li>high-Fidelity Mockups (Figma, Adobe XD)</li>
                    <li>SComplete Color Theme + Typography</li>
                    <li>Buttons, Icons, Card Design</li>
