...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_price" value="3000">
    ...
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Graphics Designing And Media Animation – Basic Package</h3>
                <div class="price">3,000 PKR</div>
                <ul class="features-list">
                    <li>Simple logo</li>
                    <li>Business card</li>
                    <li>Basic poster / flyer</li>
                    <li>Social media post (2–3 designs)</li>
                    <li>Simple banner</li>
                </ul>
            </div>
