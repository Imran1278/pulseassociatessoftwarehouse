...
<form action="../process_checkout.php" method="POST">
    <input type="hidden" name="service_title" value="Virtual Assistant Amazon">
    <input type="hidden" name="package_title" value="Enterprise Package">
    <input type="hidden" name="package_price" value="85,000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Virtual Assistant Amazon – Enterprise Package</h3>
                <div class="price">85,000 PKR</div>
                <ul class="features-list">
                    <li>Complete A–Z Amazon store management</li>
                    <li>Advanced product research</li>
                    <li>Sourcing from Alibaba/Dropshipping vendors</li>
                    <li>Profit calculation sheets</li>
                    <li>Advanced PPC</li>
                    <li>Creative assets</li>
                    <li>Complete monthly analytics report</li>
                </ul>
            </div>
