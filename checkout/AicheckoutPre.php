...
<form action="../process_checkout.php" method="POST">
    <input type="hidden" name="service_title" value="AI-Power Data Science And ML With Python">
    <input type="hidden" name="package_title" value="Enterprise Package">
    <input type="hidden" name="package_price" value="50,000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>AI-Power Data Science And ML With Python – Enterprise Package</h3>
                <div class="price">50,000 PKR</div>
                <ul class="features-list">
                    <li>Advanced ML + AI models Full documentation + research paper style report</li>
                    <li>Deep Learning (Keras/TensorFlow/PyTorch)</li>
                    <li>Time-series forecasting</li>
                    <li>SQL/NoSQL database integration</li>
                    <li>Admin dashboard (React / PHP)</li>
                    <li>API deployment (Flask/FastAPI), NLP projects</li>
                </ul>
            </div>
