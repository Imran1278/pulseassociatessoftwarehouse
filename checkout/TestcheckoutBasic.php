    ...
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Software Testing & Quality Assurance – Basic Package</h3>
                <div class="price">5,000 PKR</div>
                <ul class="features-list">
                    <li>Basic functional testing No performance testing</li>
                    <li>Manual testing only</li>
                    <li>10–20 test cases</li>
                    <li>Bug report (Excel or PDF)</li>
                    <li>Simple test plan</li>
                    <li>Small project (website/app), No automation</li>
                </ul>
            </div>
