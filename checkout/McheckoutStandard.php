...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_price" value="40000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Mobile App Development – Standard Package</h3>
                <div class="price">40,000 PKR</div>
                <ul class="features-list">
                    <li>Android And iOS</li>
                    <li>6-12 Screens</li>
                    <li>Better UI / UX</li>
                    <li>Admin Panel</li>
                    <li>Firebase Or Simple PHP Backend</li>
                    <li>Login / Signup, Database</li>
                </ul>
            </div>
