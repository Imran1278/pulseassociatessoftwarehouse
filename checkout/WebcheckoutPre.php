...
<form action="../process_checkout.php" method="POST">
    <input type="hidden" name="service_title" value="Web Designing And Development">
    ...
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Web Designing And Development – Enterprise Package</h3>
                <div class="price">1 Lakh PKR</div>
                <ul class="features-list">
                    <li>Complete custom web design</li>
                    <li>UI/UX (Figma)</li>
                    <li>Front-end: React / Vue / Angular</li>
                    <li>Back-end: Laravel / Node.js / Django</li>
                    <li>Database: MySQL / MongoDB / PostgreSQL</li>
                    <li>API integrations</li>
                    <li>100% responsive + optimized</li>
                    <li>Cloud deployment (AWS / DigitalOcean)</li>
