...
<form action="../process_checkout.php" method="POST">
    ...
    <input type="hidden" name="package_price" value="12000">
    <div class="checkout-grid">
        ...
        <div>
            <div class="card package-summary">
                ...
                <h3>Graphics Designing And Media Animation – Standard Package</h3>
                <div class="price">12,000 PKR</div>
                <ul class="features-list">
                    <li>1 premium logo</li>
                    <li>Complete brand kit</li>
                    <li>5–10 social media posts</li>
                    <li>Facebook/Instagram cover design</li>
                    <li>Professional poster/flyer</li>
                </ul>
            </div>
